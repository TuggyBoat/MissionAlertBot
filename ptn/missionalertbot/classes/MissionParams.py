class MissionParams:
    ...
    """
    def __init__(self, carrier_name_search_term, commodity_search_term, system, station,
                 profit, pads, demand, eta=None, mission_type=None, legacy=False, carrier_data=None,
                 commodity_data=None, edmc_off=False, eta_text=None, rp_text=None, reddit_post_id=None,
                 reddit_post_url=None, reddit_comment_id=None, reddit_comment_url=None,
                 discord_alert_id=None, mission_temp_channel_id=None, webhook_msg_id=None,
                 webhook_urls=None):
